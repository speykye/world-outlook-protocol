...
export declare const WORLD_OUTLOOK_PROTOCOL_ID: "world-outlook-v0.1";
...
export type WorldFeatureKey = 'guide' | 'tags' | 'collections' | 'materials' | 'timeline' | 'calendar' | 'relations' | 'map' | 'consistency' | 'law' | 'lab';
...
export type ModuleFieldType = 'text' | 'textarea' | 'singleSelect' | 'multiSelect' | 'number' | 'dateText' | 'worldDate' | 'worldDateRange' | 'tags' | 'entryRef';
...
export type CalendarYearRule = {
    mode: CalendarYearNumberingMode;
    allowYearZero: boolean;
    zeroYearLabel?: string;
};
...
export type MapFeatureSemanticType = 'city' | 'town' | 'capital' | 'ruin' | 'port' | 'country' | 'province' | 'territory' | 'river' | 'road' | 'sea_route' | 'migration_route' | 'battle_route' | 'danger_zone' | 'biome' | 'event_site' | 'custom';
export type WorldMapPoint = [number, number];
export type MapFeatureGeometry = {
    type: 'Point';
    coordinates: WorldMapPoint;
} | {
    type: 'LineString';
    coordinates: WorldMapPoint[];
} | {
...
export type WorldExportBundleVersion = '1.0.0' | '1.1.0' | '1.2.0' | '1.3.0' | '1.4.0' | '1.5.0' | '1.6.0' | '1.7.0' | '1.8.0' | '1.9.0';
